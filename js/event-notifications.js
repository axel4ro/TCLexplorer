(function () {
  ...
  const copy = {
    ...
    tr: {
      ...
      unsupported: "Bu tarayici etkinlik bildirimleri alamaz.",
      denied: "Bildirimler engellenmis. Bu site icin tarayici ayarlarindan etkinlestir.",
      ready: "Bu cihazda hatirlaticilari etkinlestir. Her telefon/tarayici bir kez etkinlestirilmeli.",
      enabledPush: "Bu cihazda aktif. Push bildirimleri site/app kapaliyken bile gelebilir.",
      enabledLocal: "Yerel hatirlaticilar aktif. Kapali app teslimi icin push API'yi yapilandir.",
      serverMissing: "Push API henuz yapilandirilmadi. Bu cihazda sadece yerel hatirlaticilar.",
      busy: "Bildirim ayarlari guncelleniyor...",
      enable: "Etkinlestir",
      disable: "Kapat",
      test: "Test",
      subscribersUnit: "Abone",
      subscribersMeta: "Live",
      subscribersError: "Yok",
      enabledTitle: "Etkinlik bildirimleri etkin",
      enabledBody: "Bu cihazda haftalik etkinlikler icin hatirlatici alacaksin.",
      testTitle: "TCL etkinlik bildirimi testi",
      testBody: "Bildirimler bu cihazda calisiyor.",
    ...
    de: {
      ...
      unsupported: "Dieser Browser kann keine Event-Benachrichtigungen empfangen.",
      denied: "Benachrichtigungen sind blockiert. Aktiviere sie in den Browser-Einstellungen fur diese Website.",
      ready: "Aktiviere Erinnerungen auf diesem Gerat. Jedes Telefon/jeder Browser muss einmal aktiviert werden.",
      enabledPush: "Auf diesem Gerat aktiv. Push-Benachrichtigungen konnen auch ankommen, wenn Website/App geschlossen ist.",
      enabledLocal: "Lokale Erinnerungen sind aktiv. Konfiguriere die Push-API fur Zustellung bei geschlossener App.",
      serverMissing: "Push-API ist noch nicht konfiguriert. Nur lokale Erinnerungen auf diesem Gerat.",
      busy: "Benachrichtigungseinstellungen werden aktualisiert...",
      enable: "Aktivieren",
      disable: "Deaktivieren",
      test: "Test",
      subscribersUnit: "Subs",
      subscribersMeta: "Live",
      subscribersError: "Nicht verfugbar",
      enabledTitle: "Event-Benachrichtigungen aktiviert",
      enabledBody: "Du erhaltst Erinnerungen fur wochentliche Events auf diesem Gerat.",
      testTitle: "TCL Event-Benachrichtigungstest",
      testBody: "Benachrichtigungen funktionieren auf diesem Gerat.",
    ...
    es: {
      ...
      unsupported: "Este navegador no puede recibir notificaciones de eventos.",
      denied: "Las notificaciones estan bloqueadas. Activalas desde los ajustes del navegador para este sitio.",
      ready: "Activa recordatorios en este dispositivo. Cada telefono/navegador debe activarse una vez.",
      enabledPush: "Activo en este dispositivo. Las notificaciones push pueden llegar aunque el sitio/app este cerrado.",
      enabledLocal: "Los recordatorios locales estan activos. Configura la API push para entrega con la app cerrada.",
      serverMissing: "La API push aun no esta configurada. Solo recordatorios locales en este dispositivo.",
      busy: "Actualizando ajustes de notificaciones...",
      enable: "Activar",
      disable: "Desactivar",
      test: "Prueba",
      subscribersUnit: "Subs",
      subscribersMeta: "Live",
      subscribersError: "No disponible",
      enabledTitle: "Notificaciones de eventos activadas",
      enabledBody: "Recibiras recordatorios de eventos semanales en este dispositivo.",
      testTitle: "Prueba de notificacion de evento TCL",
      testBody: "Las notificaciones funcionan en este dispositivo.",
    ...
    fr: {
      title: "Notifications d'evenements",
      checking: "Verification du support des notifications...",
      unsupported: "Ce navigateur ne peut pas recevoir les notifications d'evenements.",
      denied: "Les notifications sont bloquees. Active-les dans les reglages du navigateur pour ce site.",
      ready: "Active les rappels sur cet appareil. Chaque telephone/navigateur doit etre active une fois.",
      enabledPush: "Actif sur cet appareil. Les notifications push peuvent arriver meme si le site/app est ferme.",
      enabledLocal: "Les rappels locaux sont actifs. Configure l'API push pour la livraison app fermee.",
      serverMissing: "L'API push n'est pas encore configuree. Rappels locaux uniquement sur cet appareil.",
      busy: "Mise a jour des reglages de notifications...",
      enable: "Activer",
      disable: "Desactiver",
      test: "Test",
      subscribersUnit: "Subs",
      subscribersMeta: "Live",
      subscribersError: "Indisponible",
      enabledTitle: "Notifications d'evenements activees",
      enabledBody: "Tu recevras des rappels pour les evenements hebdomadaires sur cet appareil.",
      testTitle: "Test de notification evenement TCL",
    ...
    it: {
      title: "Notifiche eventi",
      checking: "Verifica supporto notifiche...",
      unsupported: "Questo browser non puo ricevere notifiche eventi.",
      denied: "Le notifiche sono bloccate. Abilitale dalle impostazioni del browser per questo sito.",
      ready: "Abilita i promemoria su questo dispositivo. Ogni telefono/browser deve essere abilitato una volta.",
      enabledPush: "Attivo su questo dispositivo. Le notifiche push possono arrivare anche con sito/app chiuso.",
      enabledLocal: "I promemoria locali sono attivi. Configura la push API per la consegna ad app chiusa.",
      serverMissing: "La push API non e ancora configurata. Solo promemoria locali su questo dispositivo.",
      busy: "Aggiornamento impostazioni notifiche...",
      enable: "Abilita",
      disable: "Disattiva",
      test: "Test",
      subscribersUnit: "Subs",
      subscribersMeta: "Live",
      subscribersError: "Non disponibile",
      enabledTitle: "Notifiche eventi abilitate",
      enabledBody: "Riceverai promemoria per gli eventi settimanali su questo dispositivo.",
      testTitle: "Test notifica evento TCL",
      testBody: "Le notifiche funzionano su questo dispositivo.",
    ...
    pl: {
      ...
      unsupported: "Ta przegladarka nie moze odbierac powiadomien o wydarzeniach.",
      denied: "Powiadomienia sa zablokowane. Wlacz je w ustawieniach przegladarki dla tej strony.",
      ready: "Wlacz przypomnienia na tym urzadzeniu. Kazdy telefon/przegladarka musi byc wlaczony raz.",
      enabledPush: "Aktywne na tym urzadzeniu. Powiadomienia push moga przyjsc nawet przy zamknietej stronie/app.",
      enabledLocal: "Lokalne przypomnienia sa aktywne. Skonfiguruj push API dla dostawy przy zamknietej app.",
      serverMissing: "Push API nie jest jeszcze skonfigurowane. Tylko lokalne przypomnienia na tym urzadzeniu.",
      busy: "Aktualizowanie ustawien powiadomien...",
      enable: "Wlacz",
      disable: "Wylacz",
      test: "Test",
      subscribersUnit: "Subs",
      subscribersMeta: "Live",
      subscribersError: "Niedostepne",
      enabledTitle: "Powiadomienia o wydarzeniach wlaczone",
      enabledBody: "Otrzymasz przypomnienia o wydarzeniach tygodniowych na tym urzadzeniu.",
      testTitle: "Test powiadomienia wydarzenia TCL",
      testBody: "Powiadomienia dzialaja na tym urzadzeniu.",
    ...
    pt: {
      title: "Notificacoes de eventos",
      checking: "Verificando suporte a notificacoes...",
      unsupported: "Este navegador nao pode receber notificacoes de eventos.",
      denied: "As notificacoes estao bloqueadas. Ative-as nas configuracoes do navegador para este site.",
      ready: "Ative lembretes neste dispositivo. Cada telefone/navegador deve ser ativado uma vez.",
      enabledPush: "Ativo neste dispositivo. Notificacoes push podem chegar mesmo com o site/app fechado.",
      enabledLocal: "Lembretes locais estao ativos. Configure a API push para entrega com app fechado.",
      serverMissing: "A API push ainda nao esta configurada. Apenas lembretes locais neste dispositivo.",
      busy: "Atualizando configuracoes de notificacao...",
      enable: "Ativar",
      disable: "Desativar",
      test: "Teste",
      subscribersUnit: "Subs",
      subscribersMeta: "Live",
      subscribersError: "Indisponivel",
      enabledTitle: "Notificacoes de eventos ativadas",
      enabledBody: "Voce recebera lembretes de eventos semanais neste dispositivo.",
      testTitle: "Teste de notificacao de evento TCL",
      testBody: "As notificacoes funcionam neste dispositivo.",
